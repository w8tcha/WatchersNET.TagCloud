...
<asp:panel id="pnlSettings" runat="server">
  ...
  <table id="tblFilterOpt" runat="server" style="margin-left:20px; width:100%;">
    <tr>
      ...
      <td>
        <asp:TextBox id="tbOccurCount" Width="50px" runat="server" CssClass="NumericTextBox"></asp:TextBox>
      </td>
    </tr>
    <tr>
      <td style="width:300px;" valign="top">
      ...
      <td>
        <asp:TextBox id="tbTags" Width="50px" runat="server" CssClass="NumericTextBox"></asp:TextBox>
      </td>
    </tr>
    <tr>
      <td style="width:300px;" valign="top">
  ...
  <table id="tblFlashOpt" runat="server" style="margin-left:20px; width:100%;">
   ...
   <tr>
      ...
      <td>
        #<asp:TextBox id="tbTcolor" runat="server" Width="100px"></asp:TextBox>
    ...
    <tr>
      ...
      <td>
        #<asp:TextBox id="tbTcolor2" runat="server" Width="100px"></asp:TextBox>
      </td>
    </tr>
    <tr>
      <td valign="top">
      ...
      <td>
        #<asp:TextBox id="tbHicolor" runat="server" Width="100px"></asp:TextBox>
      </td>
    </tr>
    <tr>
      <td valign="top">
      ...
      <td>
        #<asp:TextBox id="tbBgcolor" runat="server" Width="100px"></asp:TextBox>
      </td>
    </tr>
    <tr>
      <td valign="top">
    ...
    <tr>
      ...
      <td>
        <asp:TextBox id="tbTspeed" runat="server" Width="50px" CssClass="NumericTextBox"></asp:TextBox>
    ...
    <div id="TagSourceSettings">
      ...
      <table id="tabCustom" runat="server" style="margin-left:20px; width:100%;">
       ...
       <asp:UpdatePanel ID="upGrid" UpdateMode="Conditional" ChildrenAsTriggers="true" runat="server" oninit="UpGridInit">
            <ContentTemplate>
      ...
      <td>
        <table id="tCustomTag" style="width:100%;" runat="server">
         <tr>
            ...
            <td valign="top"><asp:TextBox id="tbCustomTag" runat="server" Width="194px"></asp:TextBox></td>
          </tr>
          <tr>
    ...
    <asp:PlaceHolder id="phReferrals" runat="server" Visible="False">
      ...
      <tr>
        ...
        <tr>
            ...
            <td>
               <asp:TextBox id="txtEndDate" Enabled="false" runat="server"></asp:TextBox>
           </td>
         </tr>
         </table>
         </asp:PlaceHolder>
      ...
      <table id="tabActiveforums" runat="server" style="margin-left:20px; width:100%;">
        <tr>
        <td></td>
        <td><asp:Label ID="lModeActiveforums" Text="Tag Source Settings - Active Forums" CssClass="Head" runat="server"></asp:Label></td>
        </tr>
        <tr>
          <td>
